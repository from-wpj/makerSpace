...
$(document).ready(function() {
	...
	// $(".pPho").on("click", function() {
	// 	$(document).ready(function() {
	// 		$("#dataTable").replaceWith('<div id="dataTable"></div>');
	// 		$("#dataTable").load("pPhotos.html");
	// 	})
	// });
	...
	$(".navMenu li").on("click", function() {
		...
		if (index == 0) {
			...
			$(".center").children('a').children('img').attr("src", "img/mc.png");
			...
			$(".ddzx").children('a').children('img').attr("src", "img/ddzx.png");
			if ($(this).hasClass("open")) {
				$(this).children('a').children('img').attr("src", "img/mc-w.png");
			} else {
				$(this).children('a').children('img').attr("src", "img/mc.png");
			}
		} else if (index == 13) {
			$(".zz").children('a').children('img').attr("src", "img/gernedang.png");
			$(".xc").children('a').children('img').attr("src", "img/xc.png");
	...
	$(".leaveMsg2").hover(function() {
		layer.tips("QQ727024586", ".leaveMsg2", {
			tips: [4, "black"]
		})
	}, function() {
		layer.closeAll("tips")
